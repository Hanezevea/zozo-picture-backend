...
import com.zozo.zozopicturebackend.manager.upload.FilePictureUpload;
import com.zozo.zozopicturebackend.manager.upload.PictureUploadTemplate;
import com.zozo.zozopicturebackend.manager.upload.UrlPictureUpload;
import com.zozo.zozopicturebackend.mapper.PictureMapper;
...
public class PictureServiceImpl extends ServiceImpl<PictureMapper, Picture>
    ...
    public PictureVO uploadPicture(Object inputSource, PictureUploadRequest pictureUploadRequest, User loginUser) {
        ...
        //支持外层传递名称：如果图片请求中有图片名称，则把图片名称复制给要入库的picture
        ...
        //转换为标准颜色todo未测试
        picture.setPicColor(ColorTransformUtils.normalizeHexColor(picture.getPicColor()));
